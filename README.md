...
* [tcb-manager-php](#tcb-manager-php)
  ...
  * [API](#API)
    * [TcbManager - 入口类](#TcbManager---入口类)
      * [`new TcbManager(array $options)`](#new-TcbManagerarray-options)
      * [`static function init(array $options): TcbManager`](#static-function-initarray-options-TcbManager)
    * [FunctionManager - 云函数管理](#FunctionManager---云函数管理)
      * [`listFunctions()` - 获取云函数列表](#listFunctions---获取云函数列表)
      * [`createFunction(string $functionName, array $code, string $handler, string $runtime, array $options = [])` - 创建函数](#createFunctionstring-functionName-array-code-string-handler-string-runtime-array-options-----创建函数)
      * [`updateFunctionCode(string $functionName, string $code, string $handler, array $options = [])` - 更新云函数代码](#updateFunctionCodestring-functionName-string-code-string-handler-array-options-----更新云函数代码)
      * [`updateFunctionConfiguration(string $functionName, array $options = [])` - 更新云函数配置](#updateFunctionConfigurationstring-functionName-array-options-----更新云函数配置)
      * [`deleteFunction(string $functionName)` - 删除云函数](#deleteFunctionstring-functionName---删除云函数)
      * [`getFunction(string $functionName)` - 获取云函数详情](#getFunctionstring-functionName---获取云函数详情)
      * [`invoke(string $functionName, array $options = [])` - 调用云函数](#invokestring-functionName-array-options-----调用云函数)
      * [`getFunctionLogs(string $functionName, array $options = [])` - 获取云函数调用日志](#getFunctionLogsstring-functionName-array-options-----获取云函数调用日志)
    * [DatabaseManager - 云数据库管理](#DatabaseManager---云数据库管理)
      * [`createCollection(string $collectionName): object` - 创建集合](#createCollectionstring-collectionName-object---创建集合)
      * [`createCollectionIfNotExists(string $collectionName): object` - 创建集合](#createCollectionIfNotExistsstring-collectionName-object---创建集合)
      * [`checkCollectionExists(string $collectionName): object` - 检查集合是否存在](#checkCollectionExistsstring-collectionName-object---检查集合是否存在)
      * [`deleteCollection(string $collectionName): object` - 删除集合](#deleteCollectionstring-collectionName-object---删除集合)
    ...
    * [StorageManager - 对象存储管理](#StorageManager---对象存储管理)
      ...
      * [`deleteObject(string $key): object` - 删除单个对象](#deleteObjectstring-key-object---删除单个对象)
      * [`getObject(string $key): object` - 下载单个对象](#getObjectstring-key-object---下载单个对象)
      * [`listObjects(array $options = []): object` - 获取对象列表](#listObjectsarray-options---object---获取对象列表)
      * [`getTemporaryObjectUrl(string $key, array $options): string` - 获取临时访问地址](#getTemporaryObjectUrlstring-key-array-options-string---获取临时访问地址)
      * [`upload(string $src, array $options = []): void` - 上传目录](#uploadstring-src-array-options---void---上传目录)
      * [`download(string $dst, array $options = []): void` - 下载目录](#downloadstring-dst-array-options---void---下载目录)
      * [`remove(array $options = []): void` - 移除目录](#removearray-options---void---移除目录)
      * [`keys(array $options = []): array` - 对象列表](#keysarray-options---array---对象列表)
...
#### `createCollection(string $collectionName): object` - 创建集合
...
#### `createCollectionIfNotExists(string $collectionName): object` - 创建集合
...
#### `deleteCollection(string $collectionName): object` - 删除集合
...
#### `import(string $collectionName, array $file, array $options = []): object` - 导入数据
...
#### `export(string $collectionName, array $file, array $options = []): object` - 导出数据
